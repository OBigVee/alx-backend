...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """method returns a dictionary with the following k-v pairs:
        ...
        for k, v in data.items():
            if k >= start and track_page < page_size:
        ...
        result_dict["next_index"] = next_index
        result_dict["page_size"] = len(result_list)

...
describe('createPushNotificationsJobs', () => {
  ...
  it('will display an error message if jobs is not an array', () => {
    expect(
    ...
    const jobInfos = [
      {
        ...
        message: 'Hey use the code 1982 to verify your account'
      },
      {
        phoneNumber: '98877665544',
        message: 'Hey use the code 1738 to verify your account'
      }
    ]
